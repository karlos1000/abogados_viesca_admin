    	...
    	<div class="panel-body">
    		<div class="container-fluid">
    			<div class="row">
                    ...
                    <div class="col-md-10">
                    	<h1 class="titulo">
                            Usuario <span class="pull-right"><a id="btnAyudaweb" onclick="mostrarAyuda('web_usuario')" href="#fancyAyudaWeb"><img src="../images/icon_ayuda.png" width="20px"></a></span>
                        </h1>
                        <ol class="breadcrumb">
                          <li><a href="index.php">Inicio</a></li>
                          <li><a href="catalogos.php?catalog=usuarios">Catalogos</a></li>
